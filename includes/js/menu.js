...
AJS.$(function ($) {
    ...
    $("#user-menu-link-content .user-item").on("click", function(e) {
        ...
        AJS.Analytics ? AJS.Analytics.triggerPrivacyPolicySafeEvent('user-menu-link-content.user-item.clicked', { "data" : id }) :
                        AJS.trigger('analyticsEvent', {name: 'user-menu-link-content.user-item.clicked', data: id});
    });
});
