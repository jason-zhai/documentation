AJS.bind("init.rte", function() {
    ...
    // create container
    var container = $("<div class=\"editor-notifications-container\"></div>").attr("id", containerId);
    var messages = $("<div></div>").attr("id", messagesId);
    container.append(messages);
    $("#wysiwyg").after(container);
    ...
    AJS.Confluence.EditorNotification = {
        ...
        notify: function(type, message, duration) {
            ...
            var messageBox = $(".aui-message", container).last();
