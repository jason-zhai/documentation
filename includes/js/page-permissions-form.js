...
AJS.PagePermissions.Controls = function (permissionManager) {
    ...
    $("div#page-permissions-error-div span.icon-close").click(function() {
        $("div#page-permissions-error-div").addClass("hidden");
    });
    ...
    var validator = {
        ...
        handleNonExistentEntityNames : function (entityNames) {
            ...
            $("div#page-permissions-error-div").find("p").text(errorMsg).end().removeClass("hidden");
        },
