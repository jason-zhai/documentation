...
jQuery.fn.renderBreadcrumbs = function (items) {
    ...
    html.push(Confluence.Templates.Dialog.breadcrumbItem({
        text: space.title,
        title: space.title,
...
AJS.toInit(function ($) {
    ...
    AJS.MoveDialog.Breadcrumbs = function (breadcrumbsElement, getBreadcrumbs) {
        ...
        return {
            ...
            update: function (options, controls) {
                breadcrumbsElement.html(Confluence.Templates.Dialog.breadcrumbLoading());
                ...
                (getBreadcrumbs || AJS.MoveDialog.getBreadcrumbs)(options,
                    function (breadcrumbs, textStatus) {
                        ...
                        if (textStatus != "success" || !breadcrumbs) {
                            breadcrumbsElement.html(Confluence.Templates.Dialog.breadcrumbError());
                            return;
                        }
    ...
    /**
     * @deprecated Use Confluence.Dialogs.Breadcrumbs instead
     */
    AJS.Breadcrumbs = {};
    /**
    ...
    Confluence.Dialogs.Breadcrumbs.Controller = AJS.MoveDialog.Breadcrumbs;
    Confluence.Dialogs.Breadcrumbs.defaultGetBreadcrumbs = AJS.MoveDialog.getBreadcrumbs;
