AJS.toInit(function($) {
    ...
    $("body")
        .on('click', '#draft-status .view-diff-link', function (e) { // For edit page
            openDiffDialog($(this), false);
            return AJS.stopEvent(e);
        })
        .on('click', '#draft-messages .view-diff-link', function (e) { // For existing-changes banner
    ...
    $('#draft-space-list')
        .on('click', '.view-diff-link', function (e) {
            openDiffDialog($(this), true);
            return AJS.stopEvent(e);
        })
