AJS.toInit(function ($) {
    ...
    Confluence.MovePageDialog = function (options) {
        ...
        structure.addPanel(AJS.I18n.getText("move.page.dialog.panel.location"), Confluence.Templates.MovePage.movePageAdvancedPanel(templateVars), "location-panel", "location-panel-id");
        structure.addPanel(AJS.I18n.getText("move.page.dialog.search.title"), Confluence.Templates.MovePage.movePageSearchPanel(templateVars), "search-panel", "search-panel-id");
        ...
        var moveFunction = function (dialog) {
            ...
            if (space && (space != newSpaceName || spaceKey != newSpaceKey || parentPage != newParentPage)) {
                Confluence.Dialogs.Breadcrumbs.defaultGetBreadcrumbs({spaceKey:spaceKey, pageTitle:parentPage}, function () {
        ...
        structure.popup.element.find(".dialog-title").prepend(Confluence.Templates.MovePage.helpLink());
        ...
        function setErrors(errors) {
            ...
            var errorMessageText = AJS.I18n.getText("errors.occurred");
            errorMessageText += "<ul>\n<li>"
